...
func runner(cmd *cobra.Command, args []string) error {
	log.Printf("adding a postgres integration")
	...
	if err := project.AddDependencies(parameter.AddDependency{
		...
		Dependency: parameter.Postgres,
	}); err != nil {
		return err
	}

	log.Printf("succesfully add postgres integration")
	return nil
}
...
func Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "postgres",
		Short: "add postgres dependency on gogen project",
